        ...
        while ($row_result = mysqli_fetch_array($result)) {
            echo '
                <tr class="rows">
                    ...
                    <td>
                        <a data-toggle="modal" href="#editModal' . $row_result[0] . '" onclick="editCommunityData()">
                        ...
                        <div class="modal fade" id="editModal' . $row_result[0] . '" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="post" onsubmit="return editCommunitySubmit(\'' . $row_result[0] . '\',\'edit' . $row_result[0] . '\')">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="md-form row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[1] . '">
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="">社區代號：</label>
                                                    <input type="text" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[2] . '">
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="">社區地址：</label>
