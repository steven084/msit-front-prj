...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">社區繳費入帳登記</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">社區繳費入帳登記</h4>
        </div>
        <div class="card-body">
...
function downloadTableValue() {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/comPayRegister/downloadTableValue.php",
            data: {
            ...
            var FileName = "comPayRegister.csv";
...
function startGetSelectItem(functionName, Value) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/comPayRegister/getSelectItem.php",
        data: {
...
function tableSubmit() {
    $.ajax({
        type: "POST",
        url: "pages/comPayRegister/tableSubmit.php",
        data: {
...
function getTableValue(functionName, dataTableID) {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/comPayRegister/getTableValue.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
...
function getTableValue2(functionName, dataTableID) {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/comPayRegister/getTableValue2.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
