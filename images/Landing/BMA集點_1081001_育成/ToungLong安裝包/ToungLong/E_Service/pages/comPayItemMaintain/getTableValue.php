...
switch ($functionName) {
    case 'tbody':
        $sql    = "SELECT * FROM `es_compayitem` where communityID = " . $Value;
        ...
        while ($row_result = mysqli_fetch_array($result)) {
                                        ...
                                        <div class="modal-body">
                                            <div class="md-form row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="edit' . $row_result[0] . '" class="form-control" value="收入" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[3] . '" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for=""><span style="color:red">*</span>預設金額：</label>
                                                    <input type="number" min="0" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[4] . '" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for=""><span style="color:red">*</span>預設折扣金額：</label>
                                                    <input type="number" min="0" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[5] . '" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="">備註：</label>
            ...
            ';
            $tfootTotalNum  = $tfootTotalNum + (int) $row_result[4];
            $tfootTotalNum2 = $tfootTotalNum2 + (int) $row_result[5];
        }
