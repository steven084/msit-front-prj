...
// -----------------------------------------------
    $sql    = "INSERT INTO `es_compayitem` (`ID`, `ClassName`, `ItemName`, `ItemCode`, `DefaultMoney`, `DefaultDisMoney`, `Remark`, `Maintainer`, `ChangeDay`, `communityID`) VALUES (NULL, '" . $ClassName . "', '" . $ItemName . "', '" . $ItemCode . "', '" . $DefaultMoney . "', '" . $DefaultDisMoney . "', '" . $Remark . "', '" . $Maintainer . "', '" . $DateTime . "', '" . $ID . "');";
