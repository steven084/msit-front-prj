...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">商城訂單維護-訂單到貨處理</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">商城訂單維護-訂單到貨處理</h4>
        </div>
        <div class="card-body">
...
function finishModalSubmit(ID) {
    $.ajax({
        type: "POST",
        url: "pages/shOrderMaintain/finishModalSubmit.php",
        data: {
            ID: ID
        },
        cache: false,
        ...
        if (msg == "0") {
            ...
            getTableValue("tbody", "#dataTable");
            // location.href = "?function=shOrderMaintain";
        } else {
            alertMsg('danger', msg);
        }
...
function getTableValue(functionName, dataTableID) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/shOrderMaintain/getTableValue.php",
        data: {
