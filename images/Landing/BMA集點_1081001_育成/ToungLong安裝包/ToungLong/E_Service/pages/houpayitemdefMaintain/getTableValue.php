...
switch ($functionName) {
    case 'tbody':
        $sql = "SELECT A.*,B.ClassName,B.ItemName,B.ItemCode
                    FROM `es_houpayitemdefault` AS A
                    INNER JOIN `es_compayitem` AS B
                    ON A.es_compayitemID = B.ID
                    WHERE B.communityID = " . $Value;
        ...
        while ($row_result = mysqli_fetch_array($result)) {
                                        ...
                                        <div class="modal-body">
                                            <div class="md-form row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" min="0" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[6] . '" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for=""><span style="color:red">*</span>住戶ID：</label>
                                                    <input type="number" min="0" name="edit' . $row_result[0] . '" class="form-control" value="' . $row_result[7] . '" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="">備註：</label>
            ...
            $tfootTotalNum2 = $tfootTotalNum2 + (int) $row_result[2];
        }
