...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">商城廠商訂單資訊</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">商城廠商訂單資訊</h4>
        </div>
        <div class="card-body">
            <div class="form-group row">
                <div class="col-md-2">
                    ...
                    <select name="CommunitySelect2" class="custom-select" required>
...
$(document).ready(function(e) {
    getSelectItem("CommunitySelect2","");
});
...
function getSelectItem(functionName, Value) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/shUserOrder2/getSelectItem.php",
        data: {
...
function getTableValue(functionName, dataTableID) {
    var CommunityID = getSelectValue("CommunitySelect2");
    $.ajax({
        type: "POST",
        url: "pages/shUserOrder2/getTableValue.php",
        data: {
            functionName: functionName,
