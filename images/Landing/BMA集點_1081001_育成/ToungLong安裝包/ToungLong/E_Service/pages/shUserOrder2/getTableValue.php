    ...
    case 'tbody':
        ...
        if ($CommunityID == 'All') {
            ...
            $sql = "SELECT C.*,E.HouseNum,E.Name,F.Name,G.Name,B.sh_mdseID,B.Name,B.Number,B.Price,A.HandlingFee,B.Remark
                    ...
                    INNER JOIN es_community AS G
                    ON F.communityID = G.ID
                    WHERE G.ID = " . $CommunityID . " AND A.accountID =" . $ID;
        }
        ...
        while ($row_result = mysqli_fetch_array($result)) {
            ...
            array_push($arrTemp6, (int) ((int) $row_result[12]));
            array_push($arrTemp7, (int) (((int) $row_result[10] * (int) $row_result[11]) * (100 - (int) $row_result[12]) / 100));
