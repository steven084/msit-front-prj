...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">使用者帳戶維護</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">使用者帳戶維護</h4>
        </div>
        <div class="card-body">
...
function delModalSubmit(ID) {
    $.ajax({
        type: "POST",
        url: "pages/userAccountMaintain/delModal.php",
        data: {
            ID: ID
        },
        cache: false,
...
function editModalSubmit(ID, name) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/userAccountMaintain/editModal.php",
        data: {
            ID: ID,
            Password: Password
        },
...
function getTableValue(functionName, dataTableID) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/userAccountMaintain/getTableValue.php",
        data: {
