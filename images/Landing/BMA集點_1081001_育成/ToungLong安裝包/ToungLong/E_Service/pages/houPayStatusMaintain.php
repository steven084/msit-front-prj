...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">住戶繳費狀態維護</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">住戶繳費狀態維護</h4>
        </div>
        <div class="card-body">
            <div class="form-group">
                <div class="form-label-group row">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="#" onclick="downloadTableValue2()">
                            <input class="btn btn-primary btn-block" type="button" value="輸出異動日查詢資料(EXCEL)" readonly />
                        </a>
                    </div>
                </div>
            </div>
...
function downloadTableValue() {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/houPayStatusMaintain/downloadTableValue.php",
            data: {
            ...
            var FileName = "houPayStatusMaintain.csv";
...
function downloadTableValue2() {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/houPayStatusMaintain/downloadTableValue2.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
...
function startGetSelectItem(functionName, Value) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/houPayStatusMaintain/getSelectItem.php",
...
function getTableValue(functionName, dataTableID) {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/houPayStatusMaintain/getTableValue.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
...
function getTableValue2(functionName, dataTableID) {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/houPayStatusMaintain/getTableValue2.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
