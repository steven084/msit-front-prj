            ...
            <div class="form-group">
                <div class="form-label-group row">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="#" onclick="">
                            <input class="btn btn-primary btn-block" type="button" value="列印繳費單(產生編號)" readonly data-toggle="modal" data-target="#getPayPrintModal" />
                        </a>
                    </div>
                    <div class="col-md-2">
                        <label for="">
                        ...
                        <a href="#" onclick="">
                            <input class="btn btn-primary btn-block" type="button" value="列印繳費單(聯單)" readonly data-toggle="modal" data-target="#getPayPrint2Modal" />
                        </a>
                    </div>
                    <div class="col-md-2">
                        <label for="">
                        ...
                        <a href="#" onclick="houPayInform()">
                            <input class="btn btn-primary btn-block" type="button" value="進行住戶未繳款通知" readonly />
                        </a>
                    </div>
                    <div class="col-md-2">
...
<!-- alertModal-->
<div class="modal fade" id="getPayPrintModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" onsubmit="return getPayPrint()">
...
<!-- alertModal-->
<div class="modal fade" id="getPayPrint2Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" onsubmit="return getPayPrint2()">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">再次確認是否執行此功能</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
...
function getPayPrint() {
    ...
    var inputHandMan = document.getElementsByName("inputHandMan")[0].value.trim();
    ...
    if (CommunityID == "" || BuildingID == "" || StratTime == "" || EndTime == "" || PayPeriod == "") {
        ...
        if ((totalMonth % PayPeriod) == 0) {
            ...
            var url = "./pages/houPayRegister/print/getPayPrint.php";
            window.open(url + "?" +
                "CommunityID=" + CommunityID + "&" +
                "BuildingID=" + BuildingID + "&" +
                "HouseID=" + HouseID + "&" +
                ...
                "totalPayPeriod=" + totalPayPeriod + "&" +
                "PayPeriod=" + PayPeriod + "&" +
                "inputHandMan=" + inputHandMan, "web");
            hideModal('#getPayPrintModal');
...
function getPayPrint2() {
    ...
    if (CommunityID == "" || BuildingID == "" || StratTime == "" || EndTime == "" || PayPeriod == "") {
        ...
        if ((totalMonth % PayPeriod) == 0) {
            ...
            var totalPayPeriod = totalMonth / PayPeriod;
            var url = "./pages/houPayRegister/print/getPayPrint2.php";
            window.open(url + "?" +
                "CommunityID=" + CommunityID + "&" +
                "BuildingID=" + BuildingID + "&" +
                "HouseID=" + HouseID + "&" +
                ...
                "EndTime=" + EndTime + "&" +
                "totalPayPeriod=" + totalPayPeriod + "&" +
                "PayPeriod=" + PayPeriod, "web");
            hideModal('#getPayPrint2Modal');
...
//         $.ajax({
//             type: "POST",
//             url: "pages/houPayRegister/userDisProcessing.php",
//             data: {
//                 CommunityID: CommunityID,
//                 BuildingID: BuildingID,
//                 HouseSelect: HouseSelect,
...
function houPayInform() {
    ...
    if (CommunityID == "" || BuildingID == "" || HouseSelect == "" || StratTime == "" || EndTime == "") {
        ...
        $.ajax({
            type: "POST",
            url: "pages/houPayRegister/houPayInform.php",
            data: {
                CommunityID: CommunityID,
                BuildingID: BuildingID,
                HouseSelect: HouseSelect,
