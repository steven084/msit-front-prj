...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">管理費入帳統計表</h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">管理費入帳統計表</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="form-label-group row">
                        ...
                        <div class="col-md-1">
                            ...
                            <div class="custom-control custom-checkbox ">
                                ...
                                <label class="custom-control-label" for="defaultChecked">顯示小計列</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <label for="">
