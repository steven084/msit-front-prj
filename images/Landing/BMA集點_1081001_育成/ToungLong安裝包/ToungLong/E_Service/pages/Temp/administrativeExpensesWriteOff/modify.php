...
<div class="container-fluid">
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h3 class="text-primary text-center white-text py-3"><i class="fas fa-cog"></i>住戶管理費繳費單增加項目(已沖帳完)</h3>
        </div>
        <div class="card-body">
...
function pageLoadInquire() {
    $("#indexContent3").load("pages/administrativeExpensesWriteOff/managementInquire.php", pageLoadComplete());
}
