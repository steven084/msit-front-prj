...
<div class="container-fluid">
    ...
    <!-- DataTales Example -->
    <h1 class="h3 mb-2 text-gray-800">交易科目修改</h1>
            ...
            <form class="" method="post" onsubmit="">
                ...
                <div class="md-form row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="" class="form-control" value="A01" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="" class="custom-select" required>
                            ...
                            <option value="管理費" selected>管理費</option>
                ...
                <br>
                <h6 class="m-0 font-weight-bold text-danger" align="center">*已經有管理費或交易資料不能修改[類別、代碼、類別名稱、費用屬性]</h6>
