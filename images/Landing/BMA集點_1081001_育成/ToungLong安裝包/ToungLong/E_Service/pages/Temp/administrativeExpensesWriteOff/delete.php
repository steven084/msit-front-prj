...
<div class="container-fluid">
    ...
    <!-- DataTales Example -->
    <!-- <h1 class="h3 mb-2 text-gray-800">繳費單刪除</h1> -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <!-- <h6 class="m-0 font-weight-bold text-primary">設定</h6> -->
            <h3 class="text-primary text-center white-text py-3"><i class="fas fa-cog"></i>繳費單刪除</h3>
        </div>
        <div class="card-body">
                    ...
                    <form method="post" onsubmit="">
                        <div class="form-group">
                            <div class="form-label-group row">
                                <div class="col-md-12">
                                    <label for=""></label>
                                    <input class="btn btn-primary btn-block" type="submit" name="submit" value="刪除" />
                                </div>
                            </div>
                        </div>
                    </form>
