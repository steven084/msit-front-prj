...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">管理費收費統計表(月份)</h1>
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">管理費收費統計表(月份)</h6>
        </div>
        <div class="card-body">
                    ...
                    <div class="form-label-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="custom-control custom-checkbox ">
                                ...
                                <label class="custom-control-label" for="defaultChecked">SHOW承租人</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <label for=""><br />
                            ...
                            <div class="custom-control custom-checkbox ">
                                ...
                                <label class="custom-control-label" for="defaultChecked2">顯示小計</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <label for="">
