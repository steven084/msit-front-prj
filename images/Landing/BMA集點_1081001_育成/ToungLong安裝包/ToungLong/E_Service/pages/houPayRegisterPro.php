...
<div class="container-fluid">
    <!-- Page Heading -->
    <!-- <h1 class="h3 mb-2 text-gray-800">繳費流水號註銷處理</h1> -->
    <!-- <p class="mb-4">說明：</a></p> -->
    <!-- DataTales Example -->
    <div class="card shadow mb-4 m-auto">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">繳費流水號註銷處理</h4>
        </div>
        <div class="card-body">
...
function editModalSubmit(ID, Num, name, isCancel) {
    if (isCancel == '否') {
        var Num = Num;
        var Remark = document.getElementsByName(name)[0].value;
        $.ajax({
            type: "POST",
            url: "pages/houPayRegisterPro/editModal.php",
            data: {
                Num: Num,
                Remark: Remark
            },
...
function onchangeSelect(inputID, SelectID) {
    var SelectValue = getSelectValue(SelectID);
    document.getElementsByName(inputID)[0].value = SelectValue;
}
...
function getTableValue(functionName, dataTableID) {
    ...
    $.ajax({
        type: "POST",
        url: "pages/houPayRegisterPro/getTableValue.php",
        data: {
